...
class StopsControllerTest < ActionController::TestCase
  ...
  test "should create stop" do
    assert_difference('Stop.count') do
      post :create, stop: { description: @stop.description, latitude: @stop.latitude, longitude: @stop.longitude, name: @stop.name, route_id: @stop.route_id }
    end
  ...
  test "should update stop" do
    patch :update, id: @stop, stop: { description: @stop.description, latitude: @stop.latitude, longitude: @stop.longitude, name: @stop.name, route_id: @stop.route_id }
    assert_redirected_to stop_path(assigns(:stop))
  end
