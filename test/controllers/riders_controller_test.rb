...
class RidersControllerTest < ActionController::TestCase
  ...
  test "should create rider" do
    assert_difference('Rider.count') do
      post :create, rider: { count: @rider.count, integer: @rider.integer, riderType: @rider.riderType, routeID: @rider.routeID, stopID: @rider.stopID }
    end
  ...
  test "should update rider" do
    patch :update, id: @rider, rider: { count: @rider.count, integer: @rider.integer, riderType: @rider.riderType, routeID: @rider.routeID, stopID: @rider.stopID }
    assert_redirected_to rider_path(assigns(:rider))
  end
